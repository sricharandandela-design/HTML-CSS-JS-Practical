-- Implement multiple-table joins.
...
SELECT s.name,c.course_name,c.credits FROM students s JOIN enrollments e ON s.id=e.student_id JOIN courses c ON e.course_id=c.course_id;
