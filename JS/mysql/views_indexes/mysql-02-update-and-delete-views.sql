...
CREATE OR REPLACE VIEW student_names AS SELECT id,name FROM students;
UPDATE student_names SET name='Charan Updated' WHERE id=1;
SELECT * FROM student_names;
-- DELETE FROM student_names WHERE id=1; -- may be restricted depending on view definition
