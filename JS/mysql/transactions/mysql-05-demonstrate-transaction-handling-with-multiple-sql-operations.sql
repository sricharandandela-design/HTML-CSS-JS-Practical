-- Demonstrate transaction handling with multiple SQL operations.
...
START TRANSACTION;
UPDATE students SET marks=marks+2 WHERE id=1;
INSERT INTO courses(course_name,credits) VALUES('SQL Lab',3);
