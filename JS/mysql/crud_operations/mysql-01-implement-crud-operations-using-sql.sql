...
INSERT INTO students(name,email,age) VALUES('CRUD User','crud@example.com',20);
SELECT * FROM students;
UPDATE students SET marks=82 WHERE email='crud@example.com';
DELETE FROM students WHERE email='crud@example.com';
