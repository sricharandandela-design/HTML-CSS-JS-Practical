-- Implement CRUD operations using multiple related tables.
...
INSERT IGNORE INTO enrollments(student_id,course_id) VALUES(1,3);
SELECT s.name,c.course_name FROM students s JOIN enrollments e ON s.id=e.student_id JOIN courses c ON c.course_id=e.course_id;
