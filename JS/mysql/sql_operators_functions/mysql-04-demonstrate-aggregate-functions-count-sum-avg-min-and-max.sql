-- Demonstrate aggregate functions: COUNT(), SUM(), AVG(), MIN(), and MAX().
...
SELECT COUNT(*) AS total, SUM(marks) AS total_marks, AVG(marks) AS average_marks, MIN(marks) AS minimum, MAX(marks) AS maximum FROM students;
