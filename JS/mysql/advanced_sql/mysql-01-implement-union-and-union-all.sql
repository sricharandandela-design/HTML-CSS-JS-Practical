...
SELECT name FROM students WHERE department='CSE' UNION SELECT name FROM students WHERE marks>80;
SELECT name FROM students WHERE department='CSE' UNION ALL SELECT name FROM students WHERE marks>80;
